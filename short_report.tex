...
%	\label{Fig:gantt}
%\end{figure}
%\subsection{Modelling Invariant Object Recognition}
%As stated previously the brain recognises huge number of objects rapidly with ease even in noisy natural scenes.
